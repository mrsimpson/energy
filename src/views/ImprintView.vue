...
<template>
  <n-card title="Impressum">
    <p>Angaben gemäß § 5 TMG</p>
    <p>
      Oliver Jägle<br />
      Am Wiesenteich 10<br />
      64653 Lorsch<br />
    </p>
    <p>
      Kontakt<br />
      Telefon: 06251/8609983<br />
      E-Mail: energie@beimir.net<br />
    </p>
  </n-card>

  <n-card title="Haftung für Inhalte">
    <p>
  ...
  <n-card title="Haftung für Links">
    <p>
  ...
  <n-card title="Urheberrecht"
    ...
    <Explanation
      display="inline"
      text="Quelle: https://www.e-recht24.de/impressum-generator.html"
    />
  </n-card>
</template>