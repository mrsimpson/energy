<template>
  ...
  <p>Oliver Jägle<br />Am Wiesenteich 10<br />64653 Lorsch</p>
  E-Mail-Adresse:
  <p><a href="mailto:energie@beimir.net">energie@beimir.net</a></p>
  Impressum:
  <p>
    <a href="https://gaspreis.no-panic.org/imprint" target="_blank"
      >https://gaspreis.no-panic.org/imprint</a
    >
  </p>
  ...
  <p>
    ...
    Inhalten, die in eine Webseite eingebunden werden, gehören. In solchen Fall
  ...
  <p>Informationen zu uns und Weiterentwicklungen des Energiekostenrechners.</p>
  <ul class="m-elements">
    <li>
  ...
  <ul class="m-elements">
    <li>
      <strong>Matomo (ohne Cookies): </strong>Bei Matomo handelt es sich um eine
