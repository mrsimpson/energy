...
export const recommendations = computed(() => {
  ...
  const allRecommendations: Recommendation[] = [
    ...
    },
    {
      ...
      condition: () => store.waterWarmingWithGas && store.showersPerWeek > 1,
    },
    {
      ...
      condition: () => store.waterWarmingWithGas && store.showersDuration > 5,
    },
    {
      title: `Statt baden reicht auch duschen, das spart viel warmes Wasser und damit Gas.`,
      // @TODO: how much?
      condition: () => store.waterWarmingWithGas && store.bathsPerWeek > 0,
    },
    {
