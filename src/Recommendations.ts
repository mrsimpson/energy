...
const allRecommendations: Recommendation[] = [
  ...
  },
  {
    ...
    condition: () => settings.value.waterWarmingWithGas,
  },
  {
    ...
    condition: () =>
      settings.value.waterWarmingWithGas && settings.value.showersPerWeek > 1,
  },
  {
    ...
    condition: () =>
      settings.value.waterWarmingWithGas && settings.value.showersDuration > 5,
  },
  {
    title: `Statt baden reicht auch duschen, das spart viel warmes Wasser und damit Gas.`,
    // @TODO: how much?
    condition: () =>
      settings.value.waterWarmingWithGas && settings.value.bathsPerWeek > 0,
  },
  {
    ...
    condition: () => settings.value.cookWithGas,
  },
];
